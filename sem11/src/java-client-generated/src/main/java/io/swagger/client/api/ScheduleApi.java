...
public class ScheduleApi {
     ...
     * @param body Добавить расписание в БД (required)
    ...
    /**
     * Добавить расписание (asynchronously)
     * Добавить расписание
     * @param body Добавить расписание в БД (required)
     ...
     * @param id ID расписания (required)
     * @param id  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
    ...
    /**
     * Удалить расписание (asynchronously)
     * Удалить расписание по ID
     * @param id ID расписания (required)
     * @param id  (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @param scheduleId Идентификатор расписания (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    /**
     * Найти расписание по ID (asynchronously)
     * Вернуть расписание по ID
     * @param scheduleId Идентификатор расписания (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @param body Обновить расписание в БД (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    /**
     * Обновить расписание (asynchronously)
     * Обновить расписание по ID
     * @param body Обновить расписание в БД (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
