...
public class GroupApi {
     ...
     * @param body Создание новой группы в БД (required)
    ...
    /**
     * Добавить группу (asynchronously)
     * Добавить группу в базу
     * @param body Создание новой группы в БД (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call addGroupCall(Long id, Long userId, Long robotId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call addGroupValidateBeforeCall(Long id, Long userId, Long robotId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (robotId == null) {
            throw new ApiException("Missing the required parameter 'robotId' when calling addGroup(Async)");
        }
        
        com.squareup.okhttp.Call call = addGroupCall(id, userId, robotId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Group addGroup(Long id, Long userId, Long robotId) throws ApiException {
        ApiResponse<Group> resp = addGroupWithHttpInfo(id, userId, robotId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Group> addGroupWithHttpInfo(Long id, Long userId, Long robotId) throws ApiException {
        com.squareup.okhttp.Call call = addGroupValidateBeforeCall(id, userId, robotId, null, null);
        Type localVarReturnType = new TypeToken<Group>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call addGroupAsync(Long id, Long userId, Long robotId, final ApiCallback<Group> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addGroupValidateBeforeCall(id, userId, robotId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Group>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Найти группу по ID (asynchronously)
     * вернуть группу
     * @param groupId Идентификатор группы (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @param body Обновить существующую группу в базе (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    /**
     * Обновить группу (asynchronously)
     * Обновить группу
     * @param body Обновить существующую группу в базе (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateGroupCall(Long id, Long userId, Long robotId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateGroupValidateBeforeCall(Long id, Long userId, Long robotId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
        ...
        // verify the required parameter 'robotId' is set
        if (robotId == null) {
            throw new ApiException("Missing the required parameter 'robotId' when calling updateGroup(Async)");
        }
        
        com.squareup.okhttp.Call call = updateGroupCall(id, userId, robotId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Group updateGroup(Long id, Long userId, Long robotId) throws ApiException {
        ApiResponse<Group> resp = updateGroupWithHttpInfo(id, userId, robotId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Group> updateGroupWithHttpInfo(Long id, Long userId, Long robotId) throws ApiException {
        com.squareup.okhttp.Call call = updateGroupValidateBeforeCall(id, userId, robotId, null, null);
        Type localVarReturnType = new TypeToken<Group>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateGroupAsync(Long id, Long userId, Long robotId, final ApiCallback<Group> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateGroupValidateBeforeCall(id, userId, robotId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Group>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
