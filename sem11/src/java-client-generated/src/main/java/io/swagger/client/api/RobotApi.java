...
public class RobotApi {
     ...
     * @param body Создание нового робота в БД (required)
    ...
    /**
     * Добавить робота (asynchronously)
     * Добавить робота БД
     * @param body Создание нового робота в БД (required)
     ...
     * @param clianingId  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call addRobotCall(Long id, String name, String model, String versionPO, Long charge, Long garbageContainer, Long robotPollution, Long nextService, String serialNumber, Long ipAddress, Long groupId, Long clianingId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (versionPO != null)
        localVarFormParams.put("versionPO", versionPO);
        if (charge != null)
        ...
        if (clianingId != null)
        localVarFormParams.put("clianingId", clianingId);
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call addRobotValidateBeforeCall(Long id, String name, String model, String versionPO, Long charge, Long garbageContainer, Long robotPollution, Long nextService, String serialNumber, Long ipAddress, Long groupId, Long clianingId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling addRobot(Async)");
        }
        // verify the required parameter 'model' is set
        if (model == null) {
            throw new ApiException("Missing the required parameter 'model' when calling addRobot(Async)");
        }
        // verify the required parameter 'versionPO' is set
        if (versionPO == null) {
            throw new ApiException("Missing the required parameter 'versionPO' when calling addRobot(Async)");
        }
        ...
        // verify the required parameter 'clianingId' is set
        if (clianingId == null) {
            throw new ApiException("Missing the required parameter 'clianingId' when calling addRobot(Async)");
        }
        
        com.squareup.okhttp.Call call = addRobotCall(id, name, model, versionPO, charge, garbageContainer, robotPollution, nextService, serialNumber, ipAddress, groupId, clianingId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Robot addRobot(Long id, String name, String model, String versionPO, Long charge, Long garbageContainer, Long robotPollution, Long nextService, String serialNumber, Long ipAddress, Long groupId, Long clianingId) throws ApiException {
        ApiResponse<Robot> resp = addRobotWithHttpInfo(id, name, model, versionPO, charge, garbageContainer, robotPollution, nextService, serialNumber, ipAddress, groupId, clianingId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Robot> addRobotWithHttpInfo(Long id, String name, String model, String versionPO, Long charge, Long garbageContainer, Long robotPollution, Long nextService, String serialNumber, Long ipAddress, Long groupId, Long clianingId) throws ApiException {
        com.squareup.okhttp.Call call = addRobotValidateBeforeCall(id, name, model, versionPO, charge, garbageContainer, robotPollution, nextService, serialNumber, ipAddress, groupId, clianingId, null, null);
        Type localVarReturnType = new TypeToken<Robot>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call addRobotAsync(Long id, String name, String model, String versionPO, Long charge, Long garbageContainer, Long robotPollution, Long nextService, String serialNumber, Long ipAddress, Long groupId, Long clianingId, final ApiCallback<Robot> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addRobotValidateBeforeCall(id, name, model, versionPO, charge, garbageContainer, robotPollution, nextService, serialNumber, ipAddress, groupId, clianingId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Robot>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param robotId ID робота (required)
     ...
     * @param robotId Идентификатор робота (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public com.squareup.okhttp.Call getRobotByIdCall(Long robotId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/Robot/findById/{robotId}"
            .replaceAll("\\{" + "robotId" + "\\}", apiClient.escapeString(robotId.toString()));
    ...
    /**
     * Найти робота по ID (asynchronously)
     * Вернуть одного робота по ID
     * @param robotId Идентификатор робота (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Обновить робота (asynchronously)
     * Обновить робота
     * @param body Создание нового робота в БД (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateRobotCall(Long id, String name, String model, String versionPO, Long charge, Long garbageContainer, Long robotPollution, Long nextService, String serialNumber, Long ipAddress, Long groupId, Long clianingId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateRobotValidateBeforeCall(Long id, String name, String model, String versionPO, Long charge, Long garbageContainer, Long robotPollution, Long nextService, String serialNumber, Long ipAddress, Long groupId, Long clianingId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
        ...
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling updateRobot(Async)");
        }
        // verify the required parameter 'model' is set
        if (model == null) {
        ...
        // verify the required parameter 'versionPO' is set
        if (versionPO == null) {
            throw new ApiException("Missing the required parameter 'versionPO' when calling updateRobot(Async)");
        }
        // verify the required parameter 'charge' is set
        if (charge == null) {
        ...
        // verify the required parameter 'clianingId' is set
        if (clianingId == null) {
            throw new ApiException("Missing the required parameter 'clianingId' when calling updateRobot(Async)");
        }
        
        com.squareup.okhttp.Call call = updateRobotCall(id, name, model, versionPO, charge, garbageContainer, robotPollution, nextService, serialNumber, ipAddress, groupId, clianingId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Robot updateRobot(Long id, String name, String model, String versionPO, Long charge, Long garbageContainer, Long robotPollution, Long nextService, String serialNumber, Long ipAddress, Long groupId, Long clianingId) throws ApiException {
        ApiResponse<Robot> resp = updateRobotWithHttpInfo(id, name, model, versionPO, charge, garbageContainer, robotPollution, nextService, serialNumber, ipAddress, groupId, clianingId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Robot> updateRobotWithHttpInfo(Long id, String name, String model, String versionPO, Long charge, Long garbageContainer, Long robotPollution, Long nextService, String serialNumber, Long ipAddress, Long groupId, Long clianingId) throws ApiException {
        com.squareup.okhttp.Call call = updateRobotValidateBeforeCall(id, name, model, versionPO, charge, garbageContainer, robotPollution, nextService, serialNumber, ipAddress, groupId, clianingId, null, null);
        Type localVarReturnType = new TypeToken<Robot>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateRobotAsync(Long id, String name, String model, String versionPO, Long charge, Long garbageContainer, Long robotPollution, Long nextService, String serialNumber, Long ipAddress, Long groupId, Long clianingId, final ApiCallback<Robot> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateRobotValidateBeforeCall(id, name, model, versionPO, charge, garbageContainer, robotPollution, nextService, serialNumber, ipAddress, groupId, clianingId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Robot>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
