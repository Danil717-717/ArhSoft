...
public class Cloud   {
   ...
   * @return cloudId
   **/
  @Schema(example = "f102b515", description = "")
   ...
   * @return idClient
   **/
  @Schema(example = "f102b515", required = true, description = "")
      @NotNull
   ...
   * @return RAM
   **/
  @Schema(example = "128", required = true, description = "Обьем оперативной памяти")
      @NotNull
   ...
   * @return CPU
   **/
  @Schema(example = "8", required = true, description = "Колличество ядер процессора")
      @NotNull
